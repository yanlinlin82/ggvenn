# show_elements
    ...
    Code
      ggplot_build(ggvenn(a, show_elements = TRUE))$data
    Output
      [[1]]
      ...
      [[4]]
           x y      label hjust vjust PANEL group nudge_x nudge_y colour family size
      1 -0.8 0 pear,peach   0.5   0.5     1    -1       0       0  black           4
      2  0.8 0      lemon   0.5   0.5     1    -1       0       0  black           4
      3  0.0 0      apple   0.5   0.5     1    -1       0       0  black           4
        angle alpha fontface lineheight
      1     0    NA        1        1.2
      2     0    NA        1        1.2
      3     0    NA        1        1.2
...
---
    ...
    Code
      ggplot_build(ggvenn(a, show_elements = TRUE, label_sep = "\n"))$data
    Output
      [[1]]
                    x             y group   fill PANEL colour linewidth linetype
      1    0.33333333  0.000000e+00     1   blue     1     NA       0.5        1
